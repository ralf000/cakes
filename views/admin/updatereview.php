<form action="updatereview.php" method="post" enctype="multipart/form-data">

    <input type="hidden" id="id" name="id" value="<?= \components\request\RequestRegistry::getRequest()->getProperty('id') ?>">

    <div class="form-group">
        <label for="name">Имя</label>
        <input type="text" name="name" id="name" class="form-control" required value="<?= $this->review['name'] ?>"/>
    </div>
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="image" name="image" class="form-control" value="<?= $this->review['image'] ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label for="review">Отзыв</label>
        <textarea name="review" id="review" cols="30" rows="10"><?= $this->review['review'] ?></textarea>
    </div>
