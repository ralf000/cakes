...
$config = array(
    ...
    */
    ...
    'access_keys' => require_once dirname(__DIR__) . '/../../security/filemanager_access_keys.php',
    ...
    */
    ...
    'relative_path_from_current_pos' => array('/img/web/'), //relative path of the image folder from the current position on upload folder
